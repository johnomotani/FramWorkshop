...
def run_and_plot(wave_speed, timestep_size, n_gridpoints, timesteps_per_frame):
    # Run the simulation
    #time, grid, d, v, exact_d = simulate_wave_with_loops(wave_speed, timestep_size, n_gridpoints)
    time, grid, d, v, exact_d = simulate_wave_with_array_operations(wave_speed, timestep_size, n_gridpoints)
